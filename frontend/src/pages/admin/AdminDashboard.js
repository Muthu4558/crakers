  ...
  const fetchDashboardData = async () => {
    try {
      const [statsRes, chartRes] = await Promise.all([
        axios.get(`${import.meta.env.REACT_APP_BASE_URL}/api/admin/dashboard/stats`, {
          headers: getAuthHeader(),
        }),
        axios.get(`${import.meta.env.REACT_APP_BASE_URL}/api/admin/dashboard/sales-chart?filter=${filter}`, {
          headers: getAuthHeader(),
        }),
      ]);
